CC = gcc
CFLAGS = -O3 -fomit-frame-pointer -funroll-loops -march=skylake -m64 -pedantic -std=gnu99
LDFLAGS = -static
...
OBJECTS = bipoly.o class_inv.o classpoly.o classpoly_crt.o classpoly_inv.o compute_classpoly.o phi_eval.o phi_gcd.o phi_poly.o polycosts.o velu.o \
		  crt.o cstd.o ecurve.o ecurve_ladic.o evec.o findcurve.o mpzutil.o ntutil.c prime.c pickprimes.o iqclass.o qform.o table.o tecurve.o
PROGRAMS = classpoly
